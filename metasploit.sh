...
clear
echo
center "Улаление старой папки metasploit..."
...
echo Metasploit установлен! Запустите его этой командой: msfconsole
center "*"
bash postgresql_ctl.sh
center "*"
